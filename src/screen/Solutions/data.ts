...
export const SubTitle = "Running a contest is hard. We can help make it simple and save you time, while offering the best experience for your participants.";
export const ManagementTitle = "We are all about saving you money and time, while allowing you to offer your participants the best experience possible.";